...
{
       0,   115,   115,   115,   116,   119,   120,   121,   122,   125,
     125,   134,   145,   146,   149,   150,   153,   163,   164,   167,
     181,   182,   185,   185,   195,   203,   211,   212,   220,   228,
     237
};
#endif
...
{
  "$end", "error", "$undefined", "NOMBRE", "OPREL", "IF", "ELSE", "WHILE",
  "FOR", "ID", "'+'", "'-'", "'*'", "'/'", "'='", "';'", "'{'", "'}'",
  "'('", "')'", "$accept", "programme", "$@1", "instruction",
  "affectation", "$@2", "ifelse", "instif", "instelse", "tantque",
  "instantque", "pour", "instfor", "condition", "$@3", "expr", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
      ...
      43,    45,    42,    47,    61,    59,   123,   125,    40,    41
};
# endif
...
{
      43,    -4,    -3,    -1,   -38,    16,   -38,    14,   -38,   -38,
     -38,    25,    25,    21,    17,   -38,    43,   -38,   -38,   -38,
      25,    13,    29,    18,    20,    25,   -38,    34,    33,   -38,
      25,    25,    25,    25,    38,    25,    -7,   -38,    43,    25,
      -2,    -2,   -38,   -38,    43,    40,    43,    19,    -7,    43,
      39,    21,   -38,    51,   -38,   -38,    41,    42,    45,    43,
      43,    43,    46,    43,    47,   -38,   -38,   -38,   -38
};
...
{
       4,     0,     0,     0,     9,     0,     2,     0,     6,     7,
       8,     0,     0,     0,     0,     1,     4,     5,    25,    24,
       0,     0,     0,     0,     0,     0,     3,     0,     0,    22,
       0,     0,     0,     0,     0,     0,    10,    26,    13,     0,
      27,    28,    30,    29,    18,     0,    13,     0,    23,    18,
       0,     0,    12,     0,    17,    16,     0,     0,     0,    15,
      21,    15,     0,    21,     0,    14,    11,    20,    19
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -38,    49,   -38,   -37,   -13,   -38,   -38,    22,     1,   -38,
      10,   -38,     3,   -10,   -38,   -12
};
...
{
      24,    46,    23,    30,    31,    32,    33,    49,    27,    46,
      32,    33,    49,    36,    11,    12,    15,    13,    40,    41,
      42,    43,    61,    63,    61,    45,    63,    48,    18,    17,
       4,    25,    28,    29,    19,    35,    53,    34,    56,    30,
      31,    32,    33,    20,    30,    31,    32,    33,     1,    38,
       2,     3,     4,    37,    44,    51,    55,    57,    59,    54,
      58,    60,    65,    66,    68,    26,    67,     0,    52
};

static const yytype_int8 yycheck[] =
{
      13,    38,    12,    10,    11,    12,    13,    44,    20,    46,
      12,    13,    49,    25,    18,    18,     0,    18,    30,    31,
      32,    33,    59,    60,    61,    35,    63,    39,     3,    15,
       9,    14,    19,     4,     9,    15,    17,    19,    51,    10,
      11,    12,    13,    18,    10,    11,    12,    13,     5,    16,
       7,     8,     9,    19,    16,    15,    17,     6,    16,    49,
      19,    16,    61,    17,    17,    16,    63,    -1,    46
};
...
{
       0,     5,     7,     8,     9,    21,    23,    24,    26,    29,
      31,    18,    18,    18,    25,     0,    22,    15,     3,     9,
      18,    33,    35,    33,    24,    14,    21,    35,    19,     4,
      10,    11,    12,    13,    19,    15,    35,    19,    16,    34,
      35,    35,    35,    35,    16,    33,    23,    27,    35,    23,
      30,    15,    27,    17,    30,    17,    24,     6,    19,    16,
      16,    23,    28,    23,    32,    28,    17,    32,    17
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
{
       0,    20,    22,    21,    21,    23,    23,    23,    23,    25,
      24,    26,    27,    27,    28,    28,    29,    30,    30,    31,
      32,    32,    34,    33,    35,    35,    35,    35,    35,    35,
      35
};
...
#line 130 "simple.y" /* yacc.c:1646  */
    { assigne->affectation->expression = (yyvsp[0]);
			  (yyval) = assigne; }
...
#line 135 "simple.y" /* yacc.c:1646  */
    { ssion = new instruction_t;
				  ssion->valeur = "if/else";
				  ssion->ifelse = new ifelse_t;
				  ssion->ifelse->condition = new condition_t;
				  ssion->ifelse->condition->gauche = (yyvsp[-8]); 
				  ssion->ifelse->instructionsIf = (yyvsp[-5]);
				 ssion->ifelse->instructionsElse = (yyvsp[-1]);
						(yyval) = ssion;}
...
#line 154 "simple.y" /* yacc.c:1646  */
    {tantq = new instruction_t;
				  ...
				  tantq->whouail->condition->gauche = (yyvsp[-4]); 
				  tantq->whouail->instructionsWhile = (yyvsp[-1]);
				  (yyval) = tantq;
	}
...
#line 169 "simple.y" /* yacc.c:1646  */
    {pourq = new instruction_t;
				  ...
				  pourq->foor->condition->gauche = (yyvsp[-6]);
				  pourq->foor->champ1 = (yyvsp[-8])->affectation; 
				  pourq->foor->champ3 = (yyvsp[-4])->affectation; 
				  pourq->foor->instructionsFor = (yyvsp[-1]);
				  (yyval) = pourq;
...
#line 190 "simple.y" /* yacc.c:1646  */
    { booleenne->condition->gauche = (yyvsp[-3]);
	            	 booleenne->condition->droite = (yyvsp[0]);
			 (yyval) = booleenne; }
...
#line 195 "simple.y" /* yacc.c:1646  */
    { (yyval) = new instruction_t;
     			  (yyval)->valeur = "expression";
     			  (yyval)->expression = new noeud_t;
                  (yyval)->expression->valeur = string(yytext);
                  (yyval)->expression->gauche = nullptr;
                  (yyval)->expression->droite = nullptr;
     			  (yyval)->suivante = nullptr; }
...
#line 212 "simple.y" /* yacc.c:1646  */
    { (yyval) = new instruction_t;
					  (yyval)->valeur = "expression";
					  (yyval)->expression = new noeud_t;
					  (yyval)->expression->valeur = string("+");
					  (yyval)->expression->gauche = (yyvsp[-2]);
					  (yyval)->expression->droite = (yyvsp[0]);
					  (yyval)->suivante = nullptr; }
